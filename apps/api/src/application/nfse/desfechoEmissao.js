...
const CODIGOS_NOSSOS = new Set([
  ...
  // Retenção federal (art. 30 da Lei 10.833/2003). Todas de PRÉ-VOO — o conserto é no perfil.
  "NFSE_RETENCAO_FEDERAL_SEM_CST",
  "NFSE_RETENCAO_FEDERAL_SEM_BASE",
  // E0720: `vRetCSLL` informado com `tpRetPisCofins = 0` é combinação PROIBIDA.
  "NFSE_PIS_COFINS_CSLL_SEM_RETENCAO",
  "NFSE_ISS_RETIDO_SEM_ALIQUOTA",
  "NFSE_PERFIL_INDISPONIVEL",
  "NFSE_TRIBUTACAO_MUNICIPAL_INVALIDA",
  "NFSE_RETENCOES_COMPLEMENTARES_INVALIDAS",
  "NFSE_DADOS_ESPECIAIS_INVALIDOS",
  "NFSE_EXPORTACAO_NAO_SUPORTADA",
  "NO_COMPANY_CERT",
  "CERT_CNPJ_MISMATCH",
