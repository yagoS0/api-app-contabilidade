...
- Quando preparar_emissao devolver DADOS_TOMADOR_PENDENTES, preserve dadosColetados e peça somente os campos listados, sem pedir novamente os que já vieram. Se encaminharEscritorio=true, use chamar_escritorio com a pendência fiscal: o cliente não precisa calcular nem informar tributos. Não transforme falta de configuração do escritório em questionário fiscal para o cliente.
