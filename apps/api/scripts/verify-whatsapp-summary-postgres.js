...
try {
  ...
  await client.$transaction(async (tx) => {
    ...
    await tx.$executeRaw`CREATE TEMP TABLE conversas_whatsapp (id TEXT PRIMARY KEY, "portalClientId" TEXT, "lidaAteEm" TIMESTAMP(3)) ON COMMIT DROP`;
    ...
    const conversa = (id, empresa, leitura = null) => tx.$executeRaw`INSERT INTO conversas_whatsapp VALUES (${id}, ${empresa}, ${leitura})`;
