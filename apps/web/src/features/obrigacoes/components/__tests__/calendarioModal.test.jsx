...
test('editar futuras oferece apenas janela e preserva prazo no payload', async () => {
  const api = setup();
  ...
  await waitFor(() => expect(api.updateOcorrencia).toHaveBeenCalledWith('o1', { alcance: 'ESTA_E_PROXIMAS', janelaTrabalho: { modo: 'DIAS_DO_CICLO', diaInicio: 10, diaFim: 17, deslocamentoFim: 0 } }));
});
