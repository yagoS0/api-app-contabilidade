...
export function FluxoComercial({ api, onboardingId, conversaId: conversaInformada = null }) {
  ...
  const jornada = estado ? { ...montarJornada(estado), ...(estado.jornada?.projecao || {}) } : null;
