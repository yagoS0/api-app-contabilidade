// ⚠⚠ ÓRFÃO — NENHUM ARQUIVO DESTE APP IMPORTA `ProcuracoesPanel`. Medido em 24/08/2026 por
...
//
// ⚠ O último commit dele é a varredura de cor DESTA MESMA rodada: eu "consertei" o contraste de um componente que ninguém renderiza. Isso é o custo do órfão — ele consome revisão, varredura e leitura para sempre, sem nunca chegar a uma tela.
//
