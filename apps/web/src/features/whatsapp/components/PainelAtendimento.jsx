...
export function PainelAtendimento({ children }) {
  ...
  return <>
    <div className="wa-lead-toolbar"><span>Análise, proposta e contratação</span>
      <Button ref={abrirRef} variant="secondary" size="sm" aria-expanded={aberto} onClick={() => setAberto(true)}>Abrir atendimento</Button>
    </div>
