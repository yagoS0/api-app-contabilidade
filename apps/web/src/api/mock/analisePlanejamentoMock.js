...
export function analisePlanejamentoMock(id,{de,ate,comparar='anterior'}) {
  ...
  const variacoes=Object.fromEntries(Object.keys(atual.indicadores).map(k=>{const a=atual.indicadores[k],b=anterior.indicadores[k],p=k.startsWith('margem')||k==='carga';return [k,{absoluta:a==null||b==null?null:a-b,percentual:p||!b||a==null?null:(a/b-1)*100,texto:p&&a!=null?`${(a-b).toFixed(2)} p.p.`:'Sem base comparável'}];}));
